...
git clone --single-branch --depth=1 https://github.com/sbwml/openwrt_helloworld package/helloworld

# # 更新 golang 1.24 版本
# rm -rf feeds/packages/lang/golang
# git clone --single-branch --depth=1 https://github.com/sbwml/packages_lang_golang -b 24.x feeds/packages/lang/golang
